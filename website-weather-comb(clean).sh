...
area=$(lynx https://weather.com/weather/today/l/USNY0996:1:US -dump -nolist| sed -n '/ LLC/,/Radar/p'|sed 's/© 2017 The Weather Company, LLC//'| sed 's/* Radar//'|sed -e '1,4d;13d;9d;17d;18d'|sed 's/\^°/°F/g'|sed 's/as of/UPDATED: /'|sed -n 1p|sed -e 's/^[ \t]*//');
